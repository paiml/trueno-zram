...
- [Compression Algorithms](./concepts/algorithms.md)
- [SIMD Acceleration](./concepts/simd.md)
- [GPU Batch Compression](./concepts/gpu.md)
- [Same-Fill Detection](./concepts/samefill.md)

# API Reference

- [CompressorBuilder](./api/compressor-builder.md)
- [GPU Batch API](./api/gpu-batch.md)
- [Kernel Compatibility](./api/compat.md)

# Performance

- [Benchmarks](./performance/benchmarks.md)
- [Tuning Guide](./performance/tuning.md)
- [PCIe 5x Rule](./performance/pcie-rule.md)
